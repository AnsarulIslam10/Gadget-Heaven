...
const Root = () => {
 const [cartLength, setCartLength] = useState(Number(localStorage.getItem('cartLength')) || 0);
 const [wishlistLength, setWishlistLength] = useState(Number(localStorage.getItem('wishlistLength')) || 0);
